...
class CrudOperationXylophoneCommand extends GeneratorCommand
{
    /**
     ...
     * @var string
     */
    protected $name = 'xylophone:crud-operation';
     ...
     * @var string
     */
    protected $signature = 'xylophone:crud-operation {name}';
     ...
     * @var string
     */
    protected $description = 'Generate a Xylophone CRUD operation trait';
