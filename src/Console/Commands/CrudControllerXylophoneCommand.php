...
class CrudControllerXylophoneCommand extends GeneratorCommand
{
    /**
     ...
     * @var string
     */
    protected $name = 'xylophone:crud-controller';
     ...
     * @var string
     */
    protected $signature = 'xylophone:crud-controller {name}';
     ...
     * @var string
     */
    protected $description = 'Generate a Xylophone CRUD controller';
