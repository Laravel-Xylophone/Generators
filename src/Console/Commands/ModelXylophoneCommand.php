...
class ModelXylophoneCommand extends GeneratorCommand
{
    /**
     ...
     * @var string
     */
    protected $name = 'xylophone:model';
     ...
     * @var string
     */
    protected $signature = 'xylophone:model {name} {--softdelete}';
     ...
     * @var string
     */
    protected $description = 'Generate a xylophone templated model';
