...
class CrudModelXylophoneCommand extends GeneratorCommand
{
    /**
     ...
     * @var string
     */
    protected $name = 'xylophone:crud-model';
     ...
     * @var string
     */
    protected $signature = 'xylophone:crud-model {name}';
     ...
     * @var string
     */
    protected $description = 'Generate a Xylophone CRUD model';
